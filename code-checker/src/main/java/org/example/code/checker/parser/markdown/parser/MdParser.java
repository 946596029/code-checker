...
public class MdParser extends Parser {
	...
	public static final int
		...
		NEWLINE=9, TEXT=10;
	public static final int
		RULE_document = 0, RULE_block = 1, RULE_listItem = 2, RULE_blankBlock = 3, 
		RULE_paragraph = 4, RULE_headerBlock = 5, RULE_inlineText = 6;
	private static String[] makeRuleNames() {
		return new String[] {
			"document", "block", "listItem", "blankBlock", "paragraph", "headerBlock", 
			"inlineText"
		};
	}
	...
	public final ListItemContext listItem() throws RecognitionException {
		...
		enterRule(_localctx, 4, RULE_listItem);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final BlankBlockContext blankBlock() throws RecognitionException {
		...
		enterRule(_localctx, 6, RULE_blankBlock);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
	...
	public final HeaderBlockContext headerBlock() throws RecognitionException {
		...
		enterRule(_localctx, 10, RULE_headerBlock);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
